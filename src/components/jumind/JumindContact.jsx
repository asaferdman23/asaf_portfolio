      ...
      <div className="container-jumind relative z-10">
        ...
        >
          <div className="inline-block px-6 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6 border border-white/20">
            <span className="text-[#4DA8FF] font-semibold text-sm tracking-wide uppercase">Get In Touch</span>
          </div>
          <h2 className="heading-jumind-lg text-white mb-6">
            {language === 'he' ? 'בוא נבנה משהו' : 'Let&apos;s Build Something'}
            <br />
            <span className="text-gradient-jumind">{language === 'he' ? 'מדהים ביחד' : 'Amazing Together'}</span>
          </h2>
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            {language === 'he' 
              ? 'מוכן לבנות את האפליקציה הבאה שלך? מלא את הטופס ונחזור אליך תוך 24 שעות.'
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 text-white/80">
                ...
                <div>
                  ...
                  <div className="font-semibold">Global Remote Team</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 pt-4">
              <a href="#" className="w-12 h-12 rounded-xl bg-white/10 hover:bg-[#4DA8FF] flex items-center justify-center transition-colors duration-300 border border-white/10 hover:border-[#4DA8FF]">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 shadow-2xl space-y-6">
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-[#C9D1D9]">We&apos;ll get back to you within 24 hours.</p>
                </motion.div>
              ) : (
                <>
                  <div>
