...
export default function JumindFooter() {
  ...
  const content = {
    en: {
      tagline: 'AI implementation agency for automations, AI agents, conversion landing pages, and full-stack AI systems that move your business forward.',
      ...
      webApps: 'AI Automation',
      mobileApps: 'Landing Pages',
      aiAgents: 'AI Agents',
      customSoftware: 'AI Full-Stack Systems',
      copyright: 'All rights reserved.',
      privacy: 'Privacy Policy',
      terms: 'Terms of Service',
      motto: 'AI Systems. Business Outcomes. Built Fast.',
    },
    he: {
      tagline: 'סוכנות AI לבניית אוטומציות, סוכני AI, דפי נחיתה ומערכות חכמות שעוזרות לעסק לעבוד מהר וחכם יותר.',
      ...
      webApps: 'אוטומציות AI',
      mobileApps: 'דפי נחיתה',
      aiAgents: 'סוכני AI',
      customSoftware: 'מערכות AI מקצה לקצה',
      copyright: 'כל הזכויות שמורות.',
      privacy: 'מדיניות פרטיות',
      terms: 'תנאי שימוש',
      motto: 'מערכות AI. תוצאות עסקיות. בנייה מהירה וחכמה.',
    },
  };
